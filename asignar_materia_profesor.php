    ...
    <body id="skin-blur-violate">
        ...
        <section id="main" class="p-relative" role="main">
            ...
            <section id="content" class="container">
                ...
                <!-- Basic with panel-->
                <div class="block-area" id="basic" style="max-width: 60%;">
                    <!--
                    ...
                    <?php
                        ...
                        if (isset($_POST['registrarUsuario'])) {
                            ...
                            $user = new Usuario($nombre1, $nombre2, $apellido1, $apellido2, $cedula, $fecha_nac, $direccion, $password1);
                    ...
                    <div class="tile p-15">
                        <form role="form" method="post" onsubmit="return validarPass()">
                            ...
                            <div class="form-group">
                                <input type="password" name="pass1" class="form-control input-sm m-b-10" placeholder="Password" required>
                            </div>
                            </br>
                            <div class="form-group">
                                <input type="password" name="pass2" class="form-control input-sm m-b-10" placeholder="Repite el password" required>
                            </div>
                            </br>
                            <div class="form-group">
